...
def main():
    ...
    argparser.add_argument(
        '-a', '--a_points_file',
        type=str,
        default=r'C:\Users\meraner\Desktop\00_praktikum\red_list_lichens\a_punkte\A-Aufnahmen_RL2018.csv',
        help='')
    ...
    argparser.add_argument(
        '-o', '--output',
        type=str,
        default='\\Users\\meraner\\Desktop\\output\\',
        help='')
    ...
    PATH_LUFTBILDER = "N:\prj\RL_2018\Feldarbeit\APlots_Karten\Luftbilder\\"
    PATH_TOPOMAPS = "N:\prj\RL_2018\Feldarbeit\APlots_Karten\Topomaps\\"
    PATH_LFI = "N:\prj\RL_2018\Feldarbeit\APlots_Skizzen\LFI_2018\\"
    PATH_RL2002 = "N:\prj\RL_2018\Feldarbeit\APlots_Skizzen\RL2002\\"
